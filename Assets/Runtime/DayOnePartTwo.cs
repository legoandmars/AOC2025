...
// identical to day one but just using a different aggregation method in the shader
public class DayOnePartTwo : DayBase
{
    ...
    public override void RunCode()
    {
        ...
        compute.SetBuffer(3, deltasPropertyId, finalDeltaBuffer);
        compute.SetBuffer(3, resultPropertyId, resultBuffer);
        compute.Dispatch(3, THREAD_SIZE / 32, 1, 1);
    }
